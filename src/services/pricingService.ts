import { PriceList, PricingZone, BillboardSize, QuoteItem, Quote } from '@/types'

// قائمة الأسعار الافتراضية بناءً على الصورة المرفقة
    ...
    const printContent = `
      ...
      <body>
        ...
        <div class="footer">
          ...
          <p>نشكركم لثقتكم بخدماتنا ونتط��ع للعمل معكم</p>
        </div>
